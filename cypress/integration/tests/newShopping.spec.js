...
describe('Should test shopping flow', () => {
  ...
  it('should choose 2 dresses to compare', () => {
    ...
    shoppingCartPage.clickProceedToCheckoutSummaryAndValidate(
      testData.pageNavigation.authentication
    );
    ...
    shoppingCartPage.loginAndValidate();
    shoppingCartPage.clickProceedToCheckoutStepsAndValidate(
      testData.pageNavigation.shipping
    );
    shoppingCartPage.checkTermsOfServiceAndValidate();
    shoppingCartPage.clickProceedToCheckoutStepsAndValidate(
      testData.pageNavigation.payment
    );
    shoppingCartPage.choosePaymentMethod(testData.pageNavigation.bankMethod);
    shoppingCartPage.clickProceedToCheckoutStepsAndValidate(
      testData.pageNavigation.confirmation
    );
  });
});
